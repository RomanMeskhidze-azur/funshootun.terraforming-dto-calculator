...
namespace TerraformingDtoCalculator
{
    public class TerraformingDtoCalculator
    {
        ...
        private const int MaxY = 31;
        private const int MaxZ = 31;
        ...
        public void GenerateDifferentChunkIds()
        {
            ...
            {
                var chunkIndex = random.Next(TerraformingDtoCalculatorConstants.ChunksMaxCount + 1);
        ...
        public long FillDifferentFromServerDto()
        {
           ...
           // Profiler.BeginSample("Initialize_OcTree");
            ...
            var cube = new Octangle<ChunkDTO>(OctangleType.Root, 16, 16, 16, 32, 32, 32);
            _ocTree = new OcTree<ChunkDTO>(cube);
            _ocTree.Initialization(5);
        ...
        public (long, long, long) SerDeserDiff()
        {
         ...
         //   Profiler.EndSample();
            ...
            Console.WriteLine($"ser and deser equals {_differentFromServerDto.IsEqual(deseredDto)}");
